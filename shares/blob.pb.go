...
func (x *BlobProto) Reset() {
	*x = BlobProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shares_blob_proto_msgTypes[0]
...
func (*BlobProto) Descriptor() ([]byte, []int) {
	return file_shares_blob_proto_rawDescGZIP(), []int{0}
}
...
func (x *BlobTx) Reset() {
	*x = BlobTx{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shares_blob_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BlobTx) Descriptor() ([]byte, []int) {
	return file_shares_blob_proto_rawDescGZIP(), []int{1}
}
...
func (x *IndexWrapper) Reset() {
	*x = IndexWrapper{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shares_blob_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IndexWrapper) Descriptor() ([]byte, []int) {
	return file_shares_blob_proto_rawDescGZIP(), []int{2}
}
...
var File_shares_blob_proto protoreflect.FileDescriptor

var file_shares_blob_proto_rawDesc = []byte{
	0x0a, 0x11, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x2f, 0x62, 0x6c, 0x6f, 0x62, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x70, 0x6b, 0x67, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x22,
	0xac, 0x01, 0x0a, 0x09, 0x42, 0x6c, 0x6f, 0x62, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x21, 0x0a,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x79, 0x70, 0x65, 0x49, 0x64, 0x42, 0x29, 0x5a, 0x27,
...
var (
	file_shares_blob_proto_rawDescOnce sync.Once
	file_shares_blob_proto_rawDescData = file_shares_blob_proto_rawDesc
)

func file_shares_blob_proto_rawDescGZIP() []byte {
	file_shares_blob_proto_rawDescOnce.Do(func() {
		file_shares_blob_proto_rawDescData = protoimpl.X.CompressGZIP(file_shares_blob_proto_rawDescData)
	})
	return file_shares_blob_proto_rawDescData
}

var file_shares_blob_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_shares_blob_proto_goTypes = []any{
	(*BlobProto)(nil),    // 0: pkg.shares.BlobProto
	(*BlobTx)(nil),       // 1: pkg.shares.BlobTx
	(*IndexWrapper)(nil), // 2: pkg.shares.IndexWrapper
}
var file_shares_blob_proto_depIdxs = []int32{
	0, // 0: pkg.shares.BlobTx.blobs:type_name -> pkg.shares.BlobProto
...
func init() { file_shares_blob_proto_init() }
func file_shares_blob_proto_init() {
	if File_shares_blob_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_shares_blob_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_shares_blob_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*BlobTx); i {
			case 0:
				return &v.state
			case 1:
		...
		file_shares_blob_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_shares_blob_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_shares_blob_proto_goTypes,
		DependencyIndexes: file_shares_blob_proto_depIdxs,
		MessageInfos:      file_shares_blob_proto_msgTypes,
	}.Build()
	File_shares_blob_proto = out.File
	file_shares_blob_proto_rawDesc = nil
	file_shares_blob_proto_goTypes = nil
	file_shares_blob_proto_depIdxs = nil
}
