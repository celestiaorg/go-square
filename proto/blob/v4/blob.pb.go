...
type FibreTx struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tx            []byte                 `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
	SystemBlob    *BlobProto             `protobuf:"bytes,2,opt,name=system_blob,json=systemBlob,proto3" json:"system_blob,omitempty"`
	TypeId        string                 `protobuf:"bytes,3,opt,name=type_id,json=typeId,proto3" json:"type_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FibreTx) Reset() {
	*x = FibreTx{}
	mi := &file_proto_blob_v4_blob_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FibreTx) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FibreTx) ProtoMessage() {}

func (x *FibreTx) ProtoReflect() protoreflect.Message {
	mi := &file_proto_blob_v4_blob_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FibreTx.ProtoReflect.Descriptor instead.
func (*FibreTx) Descriptor() ([]byte, []int) {
	return file_proto_blob_v4_blob_proto_rawDescGZIP(), []int{3}
}

func (x *FibreTx) GetTx() []byte {
	if x != nil {
		return x.Tx
	}
	return nil
...
func (x *FibreTx) GetSystemBlob() *BlobProto {
	if x != nil {
		return x.SystemBlob
	}
	return nil
...
func (x *FibreTx) GetTypeId() string {
	if x != nil {
		return x.TypeId
	}
	return ""
...
const file_proto_blob_v4_blob_proto_rawDesc = "" +
	...
	"\atype_id\x18\x03 \x01(\tR\x06typeId\"m\n" +
	"\aFibreTx\x12\x0e\n" +
	"\x02tx\x18\x01 \x01(\fR\x02tx\x129\n" +
	"\vsystem_blob\x18\x02 \x01(\v2\x18.proto.blob.v4.BlobProtoR\n" +
	"systemBlob\x12\x17\n" +
...
var file_proto_blob_v4_blob_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
